    ...
    stages {
        ...
        stage('Docker Tag the Image') {
            steps {
                ...
                sh 'sudo docker tag snapchat-sak-cicd-docker sanjayhegde16/snapchat-sak-cicd-docker:latest'
            }
            post {
                success {
        ...
        stage('Docker Push the Image') {
            steps {
                ...
                sh 'sudo docker push sanjayhegde16/snapchat-sak-cicd-docker:latest'
            }
            post {
                success {
        ...
        stage('Cleanup Local Docker Images') {
            steps {
                ...
                sh '''
                    sudo docker rmi sanjayhegde16/snapchat-sak-cicd-docker:latest
                    ...
                    if (containerExists) {
                        ...
                        if (userChoice == 'Yes') {
                            ...
                            sh '''
                                ...
                                sudo docker run -d -p 8084:8080 --name snapchat-container sanjayhegde16/snapchat-sak-cicd-docker:latest
                            '''
                        } else {
                        ...
                        sh 'sudo docker run -d -p 8084:8080 --name snapchat-container sanjayhegde16/snapchat-sak-cicd-docker:latest'
                    }
                }
            }
        }
